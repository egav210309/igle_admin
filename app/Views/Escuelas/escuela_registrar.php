...
<?=$this->section('contentadmin') ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Registro de escuela curzada</h1>
        </div>
        <!-- Content Row -->
        <div class="row">
          <!-- Content Column -->
           ...
           <form class="user" action="<?=base_url(route_to('escuela_regis_actualiza'))?>" method="POST" enctype="multipart/form-data" >
              <div class="card shadow mb-4">
                  <div class="card-header py-3">
                      <h6 class="m-0 font-weight-bold text-primary">Registrar Escuela</h6>
                  </div>
                                    <div class="card-body">
                      ...
                      <div class="field-body">
                            ...
                            <div class="select is-fullwidth">
                              <p class="control is-expanded has-icons-left">
                                <select class="form-control" id="id_escuela" name="id_escuela" style="padding-left: 2.5em;">
                                  ...
                                  <?php  foreach($escuelas as $escue){
                                    echo "<option value='".$escue->id_escuela."'>".ucfirst($escue->nombre_escuela)."</option>";
                                } ?>
                              </select>
                        ...
                        <div class="field col-md-4">
                          ...
                          <div class="field has-addons">
                            <div class="select is-fullwidth">
                              <p class="control is-expanded has-icons-left">
                              <select class="form-control" id="aniocursado" name="aniocursado" style="padding-left: 2.5em;" disabled>
                                  <option value=""> Año </option>
                                  <?php  foreach($aniocursado as $anio){
                                    echo "<option value='".$anio->id."'>".ucfirst($anio->nombre_detalle)."</option>";
                                } ?>
                              </select>
                              <span class="icon is-small is-left">
                    ...
                    <div class="field is-horizontal">
                      ...
                      <div class="field-body">
                        <div class="field col-md-10">
                          ...
                          <div class="control">
                            <textarea class="textarea" id="observaciones_escuela" name="observaciones_escuela" placeholder="Algún comentario acerca de la escuela cursada"><?=old('observaciones_escuela');?></textarea>
                          </div>
                        </div>
                    ...
                    <div class="field is-horizontal">
                      ...
                      <div class="field-body">
                          ...
                          <div class="field has-addons">
                            <div class="select is-fullwidth">
                              ...
                              <select class="form-control" id="estado_escuela" name="estado_escuela" style="padding-left: 2.5em;">
                                  ...
                                  <?php  foreach($estatusescu as $stat){
                                      echo "<option value='".$stat->id."'>".strtolower($stat->nombre_detalle)."</option>";
                                } ?>
                              </select>
                              <span class="icon is-small is-left">
                        ...
                        <div class="field col-md-4">
                          ...
                          <p class="control is-expanded has-icons-left">
                            <input class="input" type="date" placeholder="Casa" value="<?=old('fecha_completada')?>" id="fecha_completada" name="fecha_completada" >
                            <span class="icon is-small is-left">
