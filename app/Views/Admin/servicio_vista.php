...
<?=$this->section('contentadmin') ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Áreas de Servicio </h1>
            <?php if($seccion == 7010){ ?>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="listaservicio" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th>id</th>
                                        <th>Nombre</th>
                                ...
                                <tbody>
                                    <?php foreach ($areaservicio as $serv): ?>
                                    <tr>
                                        <td> <?= $serv->id_area ?></td>
                                        <td> <?= ucfirst($serv->nombre_area) ?></td>
                                        <td> <?= $serv->created_at ?></td>
                                        <td> <a href="<?= $serv->getEditRegisterserv() ?>"> editar</a> </td>
                                    </tr>        
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
